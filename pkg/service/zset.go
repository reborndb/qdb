...
func init() {
	Register("zadd", ZAddCmd, WriteCommandFlag)
	Register("zcard", ZCardCmd, ReadCommandFlag)
	Register("zcount", ZCountCmd, ReadCommandFlag)
	Register("zgetall", ZGetAllCmd, ReadCommandFlag)
	Register("zincrby", ZIncrByCmd, WriteCommandFlag)
	Register("zlexcount", ZLexCountCmd, ReadCommandFlag)
	Register("zrange", ZRangeCmd, ReadCommandFlag)
	Register("zrangebylex", ZRangeByLexCmd, ReadCommandFlag)
	Register("zrangebyscore", ZRangeByScoreCmd, ReadCommandFlag)
	Register("zrank", ZRankCmd, ReadCommandFlag)
	Register("zrem", ZRemCmd, WriteCommandFlag)
	Register("zremrangebylex", ZRemRangeByLexCmd, WriteCommandFlag)
	Register("zremrangebyrank", ZRemRangeByRankCmd, WriteCommandFlag)
	Register("zremrangebyscore", ZRemRangeByScoreCmd, WriteCommandFlag)
	Register("zrevrange", ZRevRangeCmd, ReadCommandFlag)
	Register("zrevrangebylex", ZRevRangeByLexCmd, ReadCommandFlag)
	Register("zrevrangebyscore", ZRevRangeByScoreCmd, ReadCommandFlag)
	Register("zrevrank", ZRevRankCmd, ReadCommandFlag)
	Register("zscore", ZScoreCmd, ReadCommandFlag)
}
