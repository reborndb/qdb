...
func init() {
	Register("hdel", HDelCmd, WriteCommandFlag)
	Register("hexists", HExistsCmd, ReadCommandFlag)
	Register("hget", HGetCmd, ReadCommandFlag)
	Register("hgetall", HGetAllCmd, ReadCommandFlag)
	Register("hincrby", HIncrByCmd, WriteCommandFlag)
	Register("hincrbyfloat", HIncrByFloatCmd, WriteCommandFlag)
	Register("hkeys", HKeysCmd, ReadCommandFlag)
	Register("hlen", HLenCmd, ReadCommandFlag)
	Register("hmget", HMGetCmd, ReadCommandFlag)
	Register("hmset", HMSetCmd, WriteCommandFlag)
	Register("hset", HSetCmd, WriteCommandFlag)
	Register("hsetnx", HSetNXCmd, WriteCommandFlag)
	Register("hvals", HValsCmd, ReadCommandFlag)
}
