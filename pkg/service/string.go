...
func init() {
	Register("append", AppendCmd, WriteCommandFlag)
	Register("decr", DecrCmd, WriteCommandFlag)
	Register("decrby", DecrByCmd, WriteCommandFlag)
	Register("get", GetCmd, ReadCommandFlag)
	Register("getset", GetSetCmd, WriteCommandFlag)
	Register("incr", IncrCmd, WriteCommandFlag)
	Register("incrby", IncrByCmd, WriteCommandFlag)
	Register("incrbyfloat", IncrByFloatCmd, WriteCommandFlag)
	Register("mget", MGetCmd, ReadCommandFlag)
	Register("mset", MSetCmd, WriteCommandFlag)
	Register("msetnx", MSetNXCmd, WriteCommandFlag)
	Register("psetex", PSetEXCmd, WriteCommandFlag)
	Register("set", SetCmd, WriteCommandFlag)
	Register("setbit", SetBitCmd, WriteCommandFlag)
	Register("setex", SetEXCmd, WriteCommandFlag)
	Register("setnx", SetNXCmd, WriteCommandFlag)
	Register("setrange", SetRangeCmd, WriteCommandFlag)
	Register("strlen", StrlenCmd, ReadCommandFlag)
}
