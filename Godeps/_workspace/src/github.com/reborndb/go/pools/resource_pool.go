...
type ResourcePool struct {
	...
	factory     Factory
	capacity    atomic2.Int64
	idleTimeout atomic2.Duration

	// stats
	waitCount atomic2.Int64
	waitTime  atomic2.Duration
}
...
func NewResourcePool(factory Factory, capacity, maxCap int, idleTimeout time.Duration) *ResourcePool {
	...
	rp := &ResourcePool{
		...
		factory:     factory,
		capacity:    atomic2.Int64(capacity),
		idleTimeout: atomic2.Duration(idleTimeout),
	}
